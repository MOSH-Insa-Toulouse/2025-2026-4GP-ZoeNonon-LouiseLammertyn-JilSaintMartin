...
The resulting resistance variation can be measured using an  voltage divider circuit, to obtain a usable analog signal.
...
\begin{figure} [h]
\centering
\includegraphics[width=0.3\textwidth,]{mesure.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,left,]{shm.png}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,left,]{pcb.png}
\end{figure}
